...
Video Link Part 1: https://drive.google.com/file/d/1LnDP8O54NCnUzg0RSsKn_hjbkIM8iTcp/view

Video Link Part 2: https://drive.google.com/file/d/12ofgpfzCm-jqWBzHOuae3w2Hekbvq6ZJ/view

Your Task
MongoDB is a popular choice for many social networks due to its speed with large amounts of data and flexibility with unstructured data. Over the last part of this course, you’ll use several of the technologies that social networking platforms use in their full-stack applications. Because the foundation of these applications is data, it’s important that you understand how to build and structure the API first.

Your challenge is to build an API for a social network web application where users can share their thoughts, react to friends’ thoughts, and create a friend list. You’ll use Express.js for routing, a MongoDB database, and the Mongoose ODM. In addition to using the Express.js (Links to an external site.) and Mongoose (Links to an external site.) packages, you’ll need to use the Moment.js package (Links to an external site.) to format time.
...
Uses the Moment.js package (Links to an external site.) to format time.
